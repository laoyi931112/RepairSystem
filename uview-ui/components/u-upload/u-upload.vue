	...
	export default {
		...
		methods: {
			...
			deleteItem(index) {
				uni.showModal({
					title: '', //提示',
					content: `${this.$t('app_confirm')}${this.$t('op_delete')}?`, //'Are you sure you want to delete this item', //您确定要删除此项吗？',
					cancelText: this.$t('enum_common_boolean_no'), //'cancel',
					confirmText: this.$t('enum_common_boolean_yes'), //'confirm',
					success: async (res) => {
						if (res.confirm) {
