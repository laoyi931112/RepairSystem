		...
		<view class="info-wrap">
			<view class="info-box">
				...
				<view class="info-content">
					<view class="info-item" style="font-size: 30rpx;font-weight: 550;color: #333;"
		...
		<view class="info-from">
			<view class="info-item" style="flex-direction: column;align-items: flex-start;justify-content: flex-start;">
				...
				<view class="info-value" style="padding: 18rpx 0rpx;width: 100%;">
					<u-input class="info-input" style="width: 100%;" :placeholder="$t('app_enter_fault')"
						type="textarea" :disabled="true" v-model="problem">
					</u-input>
				</view>
			</view>
			<view class="info-item" style="flex-direction: column;align-items: flex-start;justify-content: flex-start;">
				...
				<view class="info-value" style="padding: 18rpx 0rpx;width: 100%;">
					<r-upload :maxcount="1" :value.sync="imgs" :width="120" :height="120" :deletable="false"></r-upload>
				</view>
			</view>
...
<script>
	...
	export default {
		data() {
			return {pagetitle: 'app_maintenance_order',
				detail: {}, //详情
				problem: '',
				imgs: [],
				tenantdetail: {},
		...
		onReady() {
			uni.setNavigationBarTitle({
				title: this.$t('app_maintenance_order')
			})
		},
		methods: {
			toJSON() {},
